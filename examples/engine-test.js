 ...
 * the enhanced capabilities of the refactored OnlyOffice Macro CLI.
 */

(function() {
    console.log("=== OnlyOffice Macro CLI v2.0 Engine Test ===");
    ...
    try {
        ...
        // JSON handling
        var testObj = { name: "OnlyOffice", version: "2.0", engine: "V8/JSC" };
    ...
    console.log("\nThe refactored OnlyOffice Macro CLI is working correctly!");
