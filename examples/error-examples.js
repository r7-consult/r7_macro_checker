 ...
 * - API misuse
 * 
 * Use with: onlyoffice-macro-cli -c error-examples.js
 */
...
(function() {
    ...
    // Using browser APIs that don't exist in OnlyOffice
    // alert("This should use Api.ShowMessage() instead");
    // document.getElementById("test");
    // window.location.href = "http://example.com";
    
    // Unknown OnlyOffice API calls
